      ...
      body:ListView(
        ...
        children: <Widget>[
          ...
          crossAxisAlignment: CrossAxisAlignment.start,
           ...
           children:<Widget>[
              ...
              RichText(text:TextSpan(children:<TextSpan>[
                ...
                TextSpan(text:"Euphorbia milii.",style: TextStyle(color:Colors.black45, fontSize:16,fontStyle:FontStyle.italic)),
          ...
          RichText(text:TextSpan(children:<TextSpan>[
                ...
                TextSpan(text:"corona de espinas, corona de Cristo, espina del señor.",style: TextStyle(color:Colors.black45,fontSize:16,fontStyle:FontStyle.italic)),
...
class Scrollplantas extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    width:size.width*0.4,
     child:Column(children: <Widget>[
       Image.asset("assets/Fotos/corona.png"),
...
class Scrollplantas1 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    width:size.width*0.4,
     child:Column(children: <Widget>[
       Image.asset("assets/Fotos/corona1.png"),
...
class Scrollplantas2 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    width:size.width*0.4,
     child:Column(children: <Widget>[
       Image.asset("assets/Fotos/corona2.png"),
...
class Scrollplantas3 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    width:size.width*0.4,
     child:Column(children: <Widget>[
       Image.asset("assets/Fotos/corona3.png"),
