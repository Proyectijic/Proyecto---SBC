...
class Aucuba extends StatefulWidget {
  final String imagePath;
 
  Aucuba({this.imagePath});

  @override
  _Aucuba createState() => _Aucuba();
}



class _Aucuba extends State<Aucuba> {
      ...
      body:ListView(
        ...
        children: <Widget>[
          ...
          crossAxisAlignment: CrossAxisAlignment.start,
           ...
           children:<Widget>[
              ...
              RichText(text:TextSpan(children:<TextSpan>[
                ...
                TextSpan(text:"Aucuba japónica 'Crotonifolia'",style: TextStyle(color:Colors.black45, fontSize:16,fontStyle:FontStyle.italic)),
          ...
          RichText(text:TextSpan(children:<TextSpan>[
                ...
                TextSpan(text:"Aucuba, Laurel manchado.",style: TextStyle(color:Colors.black45,fontSize:16,fontStyle:FontStyle.italic)),
...
class Scrollplantas extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    width:size.width*0.4,
     child:Column(children: <Widget>[
       Image.asset("assets/Fotos/aucuba.png"),
...
class Scrollplantas1 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    width:size.width*0.4,
     child:Column(children: <Widget>[
       Image.asset("assets/Fotos/aucuba1.png"),
...
class Scrollplantas2 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    width:size.width*0.4,
     child:Column(children: <Widget>[
       Image.asset("assets/Fotos/aucuba2.png"),
...
class Scrollplantas3 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    width:size.width*0.4,
     child:Column(children: <Widget>[
       Image.asset("assets/Fotos/aucuba3.png"),
